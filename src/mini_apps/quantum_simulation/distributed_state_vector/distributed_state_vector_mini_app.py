...
from mini_apps.quantum_simulation.distributed_state_vector.motif.distributed_state_vector_motif import DistStateVector
import json
            ...
            for gpus in hw_config['gpus_per_node']:
                ...
                for circuit_config in BENCHMARK_CONFIG['circuit_configs']:
                    for qubit_size in circuit_config['qubit_sizes']:
                        ...
                        print(f"Running with {nodes} nodes, {gpus} GPUs, {qubit_size} qubits")
