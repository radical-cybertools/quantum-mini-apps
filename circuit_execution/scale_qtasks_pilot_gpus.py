...
def start_pilot():
    ...
    dp = PilotComputeService().create_pilot(pilot_compute_description_dask)
    dp.wait()
    dp.get_details()
    ...
    for i in range(5):
        for num_qubits in num_qubits_arr:
            ...
            result_string = "Pilot-Dask-Overhead: {}, Number Nodes: {}, Number Qubits: {} Number Circuits {} Compute: {}s classical_compute_time: {}s Quantum compute time: {}s".format(
                ...
                classical_compute_end - classical_compute_start, quantum_compute_end - quantum_compute_start)
            print(result_string)
